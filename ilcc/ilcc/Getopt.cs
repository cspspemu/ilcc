	...
	public class Getopt
	{
		...
		*/
		...
		static public TType CheckArgument<TType>(string Name, Func<TType> Action)
		{
			...
			{
				throw (new ArgumentException(String.Format("Argument '{0}' requires a '{1}'", Name, typeof(TType))));
			}
		}
		...
		public void Process()
		{
			while (HasMore)
			{
				...
				if (Current.Length > 0 && (Current[0] == '/' || Current[0] == '-'))
				{
